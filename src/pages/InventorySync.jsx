...
export default function InventorySync() {
  ...
  useEffect(() => {
    ...
    return () => {
      unsubscribeFromInventory(branchId);
    };
  }, [branchId]);
    ...
    <div className="space-y-6 animate-fade-up">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-muted-foreground mt-1">Real-time inventory synchronization across branches</p>
        </div>
        <Button onClick={handleRefresh} variant="outline" className="shrink-0 w-full sm:w-auto gap-2">
