  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; font-family: Arial, sans-serif; letter-spacing: normal !important; word-spacing: normal !important; font-variant-numeric: lnum tabular-nums !important; -webkit-font-smoothing: antialiased !important; -moz-osx-font-smoothing: grayscale !important; }
    ...
    @media print { 
      ...
      @page { margin: 0; size: auto; } /* Let browser determine height, remove default margins */
    }
...
<div class="page">
  ...
  <div class="header">
    ...
    <div class="invoice-meta">
      <div class="inv-title">${inv.type === "credit_note" ? "CREDIT NOTE" : inv.type === "debit_note" ? "DEBIT NOTE" : inv.type === "proforma" ? "PROFORMA INVOICE" : inv.type === "quotation" ? "QUOTATION" : "TAX INVOICE"}</div>
  ...
  <div style="text-align:center;margin-top:16px;font-size:9px;color:#aaa;">
    Generated by EasyBMT — ${inv.type === "proforma" ? "Proforma Invoice" : inv.type === "quotation" ? "Quotation" : "GST Compliant Tax Invoice"}
  </div>
</div>
</body>
</html>`;
...
export default function InvoicePrintPreview({ open, onOpenChange, invoice, shopSettings }) {
  ...
  const html = (isB2C && isThermal && !isGeneralInvoice) 
    ? generateThermalHTML(invoice, shopSettings, shopSettings.printer_size)
    : generateInvoiceHTML(invoice, shopSettings);
  ...
  const handleDownload = async () => {
    try {
      ...
      await downloadInvoicePDF(invoice, shopSettings, false);
